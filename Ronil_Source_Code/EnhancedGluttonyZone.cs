...
public partial class EnhancedGluttonyZone : Area2D
{
	...
	public override void _Ready()
	{
		...
		flickerTween.TweenProperty(warningVisual, "color", new Color(1.0f, 0.0f, 0.0f, 0.8f), 0.1f);
		...
		foreach (Node2D body in bodies)
		{
			if (body.IsInGroup("Player"))
			{
				if (IsBodyFullyInside(body))
				{
					...
					{
						body.Call("Die", "Player was consumed by the Enhanced Abyss.");
					}
				}
			}
		}
